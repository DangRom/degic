...
IN pContent LONGTEXT CHAR SET utf8, IN pPrice INT, IN pOrders TINYINT)
BEGIN
    INSERT INTO Courses (Name, Alias, Image, Status, ShortDesciptions, Content, Activated, Price, Orders)
    VALUES (pName, pAlias, pImage, pStatus, pShortDescriptions, pContent, pActivated, pPrice, pOrders);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
IN pStatus TINYTEXT CHAR SET utf8, IN pShortDescriptions TINYTEXT CHAR SET utf8, IN pActivated TINYINT(1),
IN pContent LONGTEXT CHAR SET utf8, IN pPrice INT, pOrders TINYINT)
BEGIN
    UPDATE Courses
    SET Name = pName, Alias = pAlias, Image = pImage, Status = pStatus, ShortDesciptions = pShortDescriptions,
        Activated = pActivated, Content = pContent, Price = pPrice, Orders = pOrders
    WHERE Id = pId;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2017-08-01  0:08:23
